...
## Learning Objectives
- Understand the central mechanism behind Neural Architecture Search
...
### 1. Problem Setup
Neural Architecture Search sits inside the broader family of Advanced Topics. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Neural Architecture Search as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Neural Architecture Search. The public API is intentionally small:
