...
## Prerequisites
- Earlier material from Advanced Topics
...
## Learning Objectives
- Understand the central mechanism behind Causal Representation Learning
...
### 1. Problem Setup
Causal Representation Learning sits inside the broader family of Advanced Topics. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Causal Representation Learning as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Causal Representation Learning. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Advanced Topics.
