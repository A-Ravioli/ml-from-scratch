...
## Learning Objectives
- Understand the central mechanism behind Pruning Quantization
...
### 1. Problem Setup
Pruning Quantization sits inside the broader family of Advanced Topics. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Pruning Quantization as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Pruning Quantization. The public API is intentionally small:
