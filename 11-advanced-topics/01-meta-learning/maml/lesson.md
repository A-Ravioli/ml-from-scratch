...
## Learning Objectives
- Understand the central mechanism behind MAML
...
### 1. Problem Setup
MAML sits inside the broader family of Meta Learning. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of MAML as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of MAML. The public API is intentionally small:
