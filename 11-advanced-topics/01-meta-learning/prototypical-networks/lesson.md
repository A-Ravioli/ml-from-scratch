...
## Learning Objectives
- Understand the central mechanism behind Prototypical Networks
...
### 1. Problem Setup
Prototypical Networks sits inside the broader family of Meta Learning. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Prototypical Networks as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Prototypical Networks. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Meta Learning.
