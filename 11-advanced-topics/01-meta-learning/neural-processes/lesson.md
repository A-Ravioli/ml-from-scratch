...
## Learning Objectives
- Understand the central mechanism behind Neural Processes
...
### 1. Problem Setup
Neural Processes sits inside the broader family of Meta Learning. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Neural Processes as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Neural Processes. The public API is intentionally small:
