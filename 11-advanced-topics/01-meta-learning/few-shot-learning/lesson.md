...
## Learning Objectives
- Understand the central mechanism behind Few Shot Learning
...
### 1. Problem Setup
Few Shot Learning sits inside the broader family of Meta Learning. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Few Shot Learning as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Few Shot Learning. The public API is intentionally small:
