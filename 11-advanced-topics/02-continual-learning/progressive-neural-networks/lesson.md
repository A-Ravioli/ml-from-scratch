...
## Learning Objectives
- Understand the central mechanism behind Progressive Neural Networks
...
### 1. Problem Setup
Progressive Neural Networks sits inside the broader family of Continual Learning. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Progressive Neural Networks as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Progressive Neural Networks. The public API is intentionally small:
