...
## Learning Objectives
- Understand the central mechanism behind Elastic Weight Consolidation
...
### 1. Problem Setup
Elastic Weight Consolidation sits inside the broader family of Continual Learning. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Elastic Weight Consolidation as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Elastic Weight Consolidation. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Continual Learning.
