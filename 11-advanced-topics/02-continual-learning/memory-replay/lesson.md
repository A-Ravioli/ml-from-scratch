...
## Learning Objectives
- Understand the central mechanism behind Memory Replay
...
### 1. Problem Setup
Memory Replay sits inside the broader family of Continual Learning. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Memory Replay as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Memory Replay. The public API is intentionally small:
