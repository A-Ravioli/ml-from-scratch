...
## Prerequisites
- Earlier material from Architectures
...
## Learning Objectives
- Understand the central mechanism behind Neural Cellular Automata
...
### 1. Problem Setup
Neural Cellular Automata sits inside the broader family of Exotic Architectures. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Neural Cellular Automata as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Neural Cellular Automata. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Exotic Architectures.
