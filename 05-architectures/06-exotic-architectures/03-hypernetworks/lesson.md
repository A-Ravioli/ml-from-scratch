...
## Learning Objectives
- Understand the central mechanism behind Hypernetworks
...
### 1. Problem Setup
Hypernetworks sits inside the broader family of Exotic Architectures. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Hypernetworks as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Hypernetworks. The public API is intentionally small:
