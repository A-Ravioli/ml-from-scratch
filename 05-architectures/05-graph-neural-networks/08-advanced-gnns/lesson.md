...
## Learning Objectives
- Understand the central mechanism behind Advanced GNNs
...
### 1. Problem Setup
Advanced GNNs sits inside the broader family of Graph Neural Networks. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Advanced GNNs as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Advanced GNNs. The public API is intentionally small:
