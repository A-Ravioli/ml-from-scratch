...
## Learning Objectives
- Understand the central mechanism behind Graphsage
...
### 1. Problem Setup
Graphsage sits inside the broader family of Graph Neural Networks. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Graphsage as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Graphsage. The public API is intentionally small:
