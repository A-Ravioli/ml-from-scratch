...
## Learning Objectives
- Understand the central mechanism behind Spectral Methods
...
### 1. Problem Setup
Spectral Methods sits inside the broader family of Graph Neural Networks. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Spectral Methods as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Spectral Methods. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Graph Neural Networks.
