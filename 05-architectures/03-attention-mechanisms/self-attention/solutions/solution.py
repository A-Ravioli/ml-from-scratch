...
class SelfAttention:
    ...
    def forward(self, X: np.ndarray, mask: Optional[np.ndarray] = None) -> np.ndarray:
        ...
        """
        # Task: Implement self-attention forward pass
...
class RelativePositionalAttention(SelfAttention):
    ...
    def get_relative_positions(self, seq_len: int) -> np.ndarray:
        ...
        """
        # Task: Compute relative position matrix
    ...
    def forward(self, X: np.ndarray, mask: Optional[np.ndarray] = None) -> np.ndarray:
        ...
        """
        # Task: Implement relative positional attention
...
def exercise_1_basic_self_attention():
    ...
    # Task: Test self-attention implementation
...
def exercise_2_masked_attention():
    ...
    # Task: Test masked attention functionality
...
def exercise_3_multi_head_attention():
    ...
    # Task: Test multi-head attention
...
def exercise_4_attention_analysis():
    ...
    # Task: Analyze attention patterns
...
def exercise_5_positional_attention():
    ...
    # Task: Test positional attention variants
