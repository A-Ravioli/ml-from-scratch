...
## Learning Objectives
- Understand the central mechanism behind Conditional Flow Matching
...
### 1. Problem Setup
Conditional Flow Matching sits inside the broader family of Flow Matching. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Conditional Flow Matching as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Conditional Flow Matching. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Flow Matching.
