...
## Learning Objectives
- Understand the central mechanism behind Optimal Transport
...
### 1. Problem Setup
Optimal Transport sits inside the broader family of Flow Matching. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Optimal Transport as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Optimal Transport. The public API is intentionally small:
