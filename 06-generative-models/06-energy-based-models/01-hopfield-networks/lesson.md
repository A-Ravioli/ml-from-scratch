...
## Learning Objectives
- Understand the central mechanism behind Hopfield Networks
...
### 1. Problem Setup
Hopfield Networks sits inside the broader family of Energy Based Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Hopfield Networks as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Hopfield Networks. The public API is intentionally small:
