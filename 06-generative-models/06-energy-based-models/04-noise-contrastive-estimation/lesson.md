...
## Learning Objectives
- Understand the central mechanism behind Noise Contrastive Estimation
...
### 1. Problem Setup
Noise Contrastive Estimation sits inside the broader family of Energy Based Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Noise Contrastive Estimation as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Noise Contrastive Estimation. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Energy Based Models.
