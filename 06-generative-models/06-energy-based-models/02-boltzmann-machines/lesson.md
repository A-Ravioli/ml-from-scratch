...
## Learning Objectives
- Understand the central mechanism behind Boltzmann Machines
...
### 1. Problem Setup
Boltzmann Machines sits inside the broader family of Energy Based Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Boltzmann Machines as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Boltzmann Machines. The public API is intentionally small:
