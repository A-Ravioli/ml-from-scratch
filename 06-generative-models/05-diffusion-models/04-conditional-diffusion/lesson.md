...
## Learning Objectives
- Understand the central mechanism behind Conditional Diffusion
...
### 1. Problem Setup
Conditional Diffusion sits inside the broader family of Diffusion Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Conditional Diffusion as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Conditional Diffusion. The public API is intentionally small:
