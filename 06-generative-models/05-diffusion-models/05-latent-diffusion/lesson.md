...
## Learning Objectives
- Understand the central mechanism behind Latent Diffusion
...
### 1. Problem Setup
Latent Diffusion sits inside the broader family of Diffusion Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Latent Diffusion as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Latent Diffusion. The public API is intentionally small:
