...
## Prerequisites
- Earlier material from Generative Models
...
## Learning Objectives
- Understand the central mechanism behind Stochastic Differential Equations
...
### 1. Problem Setup
Stochastic Differential Equations sits inside the broader family of Diffusion Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Stochastic Differential Equations as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Stochastic Differential Equations. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Diffusion Models.
