...
## Learning Objectives
- Understand the central mechanism behind Score Based Models
...
### 1. Problem Setup
Score Based Models sits inside the broader family of Diffusion Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Score Based Models as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Score Based Models. The public API is intentionally small:
