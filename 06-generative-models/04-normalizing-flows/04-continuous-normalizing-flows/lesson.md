...
## Learning Objectives
- Understand the central mechanism behind Continuous Normalizing Flows
...
### 1. Problem Setup
Continuous Normalizing Flows sits inside the broader family of Normalizing Flows. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Continuous Normalizing Flows as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Continuous Normalizing Flows. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Normalizing Flows.
