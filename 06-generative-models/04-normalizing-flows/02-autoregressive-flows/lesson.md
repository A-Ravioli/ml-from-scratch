...
## Learning Objectives
- Understand the central mechanism behind Autoregressive Flows
...
### 1. Problem Setup
Autoregressive Flows sits inside the broader family of Normalizing Flows. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Autoregressive Flows as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Autoregressive Flows. The public API is intentionally small:
