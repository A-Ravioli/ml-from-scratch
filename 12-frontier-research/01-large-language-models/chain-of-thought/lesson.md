...
## Learning Objectives
- Understand the central mechanism behind Chain of Thought
...
### 1. Problem Setup
Chain of Thought sits inside the broader family of Large Language Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Chain of Thought as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Chain of Thought. The public API is intentionally small:
