...
## Learning Objectives
- Understand the central mechanism behind Emergent Abilities
...
### 1. Problem Setup
Emergent Abilities sits inside the broader family of Large Language Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Emergent Abilities as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Emergent Abilities. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Large Language Models.
