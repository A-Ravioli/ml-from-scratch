...
## Learning Objectives
- Understand the central mechanism behind Embodied AI
...
### 1. Problem Setup
Embodied AI sits inside the broader family of Multimodal Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Embodied AI as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Embodied AI. The public API is intentionally small:
