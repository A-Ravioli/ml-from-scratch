...
## Learning Objectives
- Understand the central mechanism behind Flamingo
...
### 1. Problem Setup
Flamingo sits inside the broader family of Multimodal Models. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Flamingo as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Flamingo. The public API is intentionally small:
