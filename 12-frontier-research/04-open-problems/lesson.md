...
## Learning Objectives
- Understand the central mechanism behind Open Problems
...
### 1. Problem Setup
Open Problems sits inside the broader family of Frontier Research. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Open Problems as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Open Problems. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Frontier Research.
