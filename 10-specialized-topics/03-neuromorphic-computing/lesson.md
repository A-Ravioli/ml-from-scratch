...
## Learning Objectives
- Understand the central mechanism behind Neuromorphic Computing
...
### 1. Problem Setup
Neuromorphic Computing sits inside the broader family of Specialized Topics. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Neuromorphic Computing as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Neuromorphic Computing. The public API is intentionally small:
