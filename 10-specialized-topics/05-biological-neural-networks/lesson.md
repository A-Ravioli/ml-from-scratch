...
## Learning Objectives
- Understand the central mechanism behind Biological Neural Networks
...
### 1. Problem Setup
Biological Neural Networks sits inside the broader family of Specialized Topics. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Biological Neural Networks as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Biological Neural Networks. The public API is intentionally small:
