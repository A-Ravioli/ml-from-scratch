...
## Learning Objectives
- Understand the central mechanism behind Federated Optimization
...
### 1. Problem Setup
Federated Optimization sits inside the broader family of Advanced Optimization. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Federated Optimization as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Federated Optimization. The public API is intentionally small:
