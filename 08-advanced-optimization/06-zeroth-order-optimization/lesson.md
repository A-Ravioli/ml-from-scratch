...
## Learning Objectives
- Understand the central mechanism behind Zeroth Order Optimization
...
### 1. Problem Setup
Zeroth Order Optimization sits inside the broader family of Advanced Optimization. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Zeroth Order Optimization as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Zeroth Order Optimization. The public API is intentionally small:
