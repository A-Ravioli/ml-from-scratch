...
## Prerequisites
- Earlier material from Advanced Optimization
...
## Learning Objectives
- Understand the central mechanism behind Sharpness Aware Minimization
...
### 1. Problem Setup
Sharpness Aware Minimization sits inside the broader family of Advanced Optimization. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Sharpness Aware Minimization as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Sharpness Aware Minimization. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Advanced Optimization.
