...
## Learning Objectives
- Understand the central mechanism behind Mode Connectivity
...
### 1. Problem Setup
Mode Connectivity sits inside the broader family of Advanced Optimization. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Mode Connectivity as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Mode Connectivity. The public API is intentionally small:
