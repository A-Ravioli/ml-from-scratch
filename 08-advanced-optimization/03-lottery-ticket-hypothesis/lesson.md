...
## Learning Objectives
- Understand the central mechanism behind Lottery Ticket Hypothesis
...
### 1. Problem Setup
Lottery Ticket Hypothesis sits inside the broader family of Advanced Optimization. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Lottery Ticket Hypothesis as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Lottery Ticket Hypothesis. The public API is intentionally small:
