...
## Learning Objectives
- Understand the central mechanism behind Decision Transformers
...
### 1. Problem Setup
Decision Transformers sits inside the broader family of Offline RL. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Decision Transformers as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Decision Transformers. The public API is intentionally small:
