...
## Learning Objectives
- Understand the central mechanism behind Conservative Q Learning
...
### 1. Problem Setup
Conservative Q Learning sits inside the broader family of Offline RL. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Conservative Q Learning as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Conservative Q Learning. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Offline RL.
