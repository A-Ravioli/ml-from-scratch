...
## Learning Objectives
- Understand the central mechanism behind Batch Constrained Q
...
### 1. Problem Setup
Batch Constrained Q sits inside the broader family of Offline RL. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Batch Constrained Q as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Batch Constrained Q. The public API is intentionally small:
