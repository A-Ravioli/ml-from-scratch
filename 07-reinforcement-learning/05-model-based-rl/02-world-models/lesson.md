...
## Learning Objectives
- Understand the central mechanism behind World Models
...
### 1. Problem Setup
World Models sits inside the broader family of Model Based RL. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of World Models as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of World Models. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Model Based RL.
