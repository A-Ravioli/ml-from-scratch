...
## Learning Objectives
- Understand the central mechanism behind MuZero
...
### 1. Problem Setup
MuZero sits inside the broader family of Model Based RL. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of MuZero as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of MuZero. The public API is intentionally small:
