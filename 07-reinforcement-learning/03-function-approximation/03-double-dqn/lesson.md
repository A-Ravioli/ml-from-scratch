...
## Learning Objectives
- Understand the central mechanism behind Double DQN
...
### 1. Problem Setup
Double DQN sits inside the broader family of Function Approximation. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Double DQN as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Double DQN. The public API is intentionally small:
