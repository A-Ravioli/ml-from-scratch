...
## Learning Objectives
- Understand the central mechanism behind Deep Q Networks
...
### 1. Problem Setup
Deep Q Networks sits inside the broader family of Function Approximation. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Deep Q Networks as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Deep Q Networks. The public API is intentionally small:
