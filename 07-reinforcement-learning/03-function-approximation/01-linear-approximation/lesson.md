...
## Prerequisites
- Earlier material from Reinforcement Learning
...
## Learning Objectives
- Understand the central mechanism behind Linear Approximation
...
### 1. Problem Setup
Linear Approximation sits inside the broader family of Function Approximation. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Linear Approximation as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Linear Approximation. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Function Approximation.
