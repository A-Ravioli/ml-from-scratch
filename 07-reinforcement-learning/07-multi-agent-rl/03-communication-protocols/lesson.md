...
## Learning Objectives
- Understand the central mechanism behind Communication Protocols
...
### 1. Problem Setup
Communication Protocols sits inside the broader family of Multi Agent RL. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Communication Protocols as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Communication Protocols. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Multi Agent RL.
