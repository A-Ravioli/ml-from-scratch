...
## Learning Objectives
- Understand the central mechanism behind Nash Equilibria
...
### 1. Problem Setup
Nash Equilibria sits inside the broader family of Multi Agent RL. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Nash Equilibria as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Nash Equilibria. The public API is intentionally small:
