...
## Learning Objectives
- Understand the central mechanism behind Mean Field Games
...
### 1. Problem Setup
Mean Field Games sits inside the broader family of Multi Agent RL. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Mean Field Games as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Mean Field Games. The public API is intentionally small:
