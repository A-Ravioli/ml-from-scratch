...
## Learning Objectives
- Understand the central mechanism behind Reinforce
...
### 1. Problem Setup
Reinforce sits inside the broader family of Policy Gradient Methods. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Reinforce as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Reinforce. The public API is intentionally small:
