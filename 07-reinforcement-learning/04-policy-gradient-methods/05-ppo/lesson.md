...
## Learning Objectives
- Understand the central mechanism behind PPO
...
### 1. Problem Setup
PPO sits inside the broader family of Policy Gradient Methods. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of PPO as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of PPO. The public API is intentionally small:
