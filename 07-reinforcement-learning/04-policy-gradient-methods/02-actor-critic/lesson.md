...
## Learning Objectives
- Understand the central mechanism behind Actor Critic
...
### 1. Problem Setup
Actor Critic sits inside the broader family of Policy Gradient Methods. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Actor Critic as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Actor Critic. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Policy Gradient Methods.
