...
## Learning Objectives
- Understand the central mechanism behind TRPO
...
### 1. Problem Setup
TRPO sits inside the broader family of Policy Gradient Methods. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of TRPO as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of TRPO. The public API is intentionally small:
