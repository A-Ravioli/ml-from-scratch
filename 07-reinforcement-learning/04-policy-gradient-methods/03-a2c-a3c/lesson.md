...
## Learning Objectives
- Understand the central mechanism behind A2C A3C
...
### 1. Problem Setup
A2C A3C sits inside the broader family of Policy Gradient Methods. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of A2C A3C as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of A2C A3C. The public API is intentionally small:
