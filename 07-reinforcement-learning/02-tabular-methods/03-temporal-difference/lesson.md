...
## Learning Objectives
- Understand the central mechanism behind Temporal Difference
...
### 1. Problem Setup
Temporal Difference sits inside the broader family of Tabular Methods. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Temporal Difference as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Temporal Difference. The public API is intentionally small:
...
- Relate the toy implementation to the larger research literature in Tabular Methods.
