...
## Learning Objectives
- Understand the central mechanism behind Monte Carlo
...
### 1. Problem Setup
Monte Carlo sits inside the broader family of Tabular Methods. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Monte Carlo as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Monte Carlo. The public API is intentionally small:
