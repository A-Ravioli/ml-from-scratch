...
## Learning Objectives
- Understand the central mechanism behind Neural Tangent Kernel
...
### 1. Problem Setup
Neural Tangent Kernel sits inside the broader family of Theoretical Deep Learning. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Neural Tangent Kernel as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Neural Tangent Kernel. The public API is intentionally small:
