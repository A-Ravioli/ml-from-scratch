...
## Learning Objectives
- Understand the central mechanism behind Feature Learning
...
### 1. Problem Setup
Feature Learning sits inside the broader family of Theoretical Deep Learning. The core goal is to define a transformation, update rule, or representation that captures the structure we care about while remaining computationally tractable.
...
Think of Feature Learning as an iterative transformation on a state or representation:
...
The companion exercise focuses on a compact pedagogical version of Feature Learning. The public API is intentionally small:
